...
![カスタム更新多言語再生リストの詳細](media/custom_update_ml_pldetail.png)
...
![カスタム多言語プレイリストアセットの作成](media/custom_ml_pl_createasset.png)
...
![カスタム多言語再生リストの編集の詳細](media/custom_ml_pl_editdetailit.png) 
7. 翻訳するプレイリストの詳細を翻訳者に通知するメモを作成します。  
